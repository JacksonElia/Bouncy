...
public class Spawner {
  ...
  public void spawnBasicEnemy() {
    handler.addObject(
        new BasicEnemy(random.nextInt(Game.width - 32), random.nextInt(Game.height - 64),
  ...
  public void spawnHomingEnemy() {
    ...
    handler.addObject(
        new HomingEnemy(random.nextInt(Game.width), random.nextInt(Game.height), 1, 1, 12,
            ID.HomingEnemy, player));
  }
